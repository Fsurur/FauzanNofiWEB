...
<!-- Menu -->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          <img class="second-slide" src="images/gambar2.jpg" alt="Second slide">
        </div>
        <div class="item">
          <img class="third-slide" src="images/gambar3.jpg" alt="Third slide">
        </div>
        <div class="item">
          <img class="Fourth-slide" src="images/gambar4.jpg" alt="Fourth slide">
        </div>
      </div>
...
<br>
<hr class="medium">
<p class="text-muted" style="font-size: 16px;">Copyright &copy;<script>document.write(new Date().getFullYear());</script> Nofi Amalia All rights reserved</p>
</div>
</section>
</footer>
